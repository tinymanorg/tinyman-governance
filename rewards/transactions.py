...
def prepare_claim_rewards_txn_group(ledger, user_address, timestamp, sp):
    ...
    total_power_index_1 = get_total_power_index_at(ledger, VAULT_APP_ID, timestamp)
    total_power_box_index_1 = total_power_index_1 // TOTAL_POWER_BOX_ARRAY_LEN
    total_power_index_2 = get_total_power_index_at(ledger, VAULT_APP_ID, timestamp + WEEK)
    ...
    txn_group = [
        ...
        prepare_budget_increase_txn(user_address, sp=sp, index=VAULT_APP_ID, boxes=boxes[6:]),
    ]
    txn_group[0].fee *= 3
